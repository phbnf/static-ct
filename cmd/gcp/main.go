...
var (
	...
	spannerAntispamDB          = flag.String("spanner_antispam_db", "", "EXPERIMENTAL: Spanner antispam deduplication database path projects/{projectId}/instances/{instanceId}/databases/{databaseId}.")
